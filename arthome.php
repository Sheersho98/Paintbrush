  ...
  <body>
    ...
    <div class = "content">
      <input type="text" id="myinput" name="search" placeholder="search..."><br>
          <?php
            $id = $_SESSION['art_id'];
            $sql = "SELECT* FROM artist WHERE a_id = '$id'";
      ...
      <?php
        ...
        while ($row = mysqli_fetch_array($result)){
          ...
          echo  "<a href='artproductview.php?p_id=".$p_id."'><img src='images/".$row['img']."'id='myImg' alt='".$title."'><div class='overlay'><div class='text'>".$title."</div></div></a>";
          echo "</div>";
