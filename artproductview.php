  ...
  <body>
    ...
    echo "<h1>$title</h1>";
      echo "<div id = 'content'>";
       ...
       echo "<p>$desc</p>";
       echo "<br>";
       echo "<p>Price Set for Print: $price Tk<p>";
       ?>
       <br>
       <a class = "link" href ="arteditproduct.php?p_id=<?php echo $p_id?>"> Edit Details</a>

       <a class = "link" href = "artdeleteproduct.php?p_id=<?php echo $p_id?>"> Delete Product </a>
